...
def metalign_parseargs():  # handle user arguments
	...
	parser.add_argument('--cutoff', type=float, default=0.0001, help='CMash cutoff value. Default is 0.01.')
	...
	parser.add_argument('--k2_results', default='NONE', help='Path to Kraken2 report')
